            ...
            {mode === "normal" ? (
              ...
              >
                ...
                >
                  <div className="mb-12">
                    ...
                    <p className="text-primary-text text-lg max-w-2xl leading-relaxed">
                      Deep expertise in the full stack, from high-performance
                      frontend interfaces to scalable backend architecture and
                      AI deployments.
                    </p>
                  </div>
                  <KnowledgeGraph />
                ...
                >
                  <div className="mb-12">
                    <h2 className="text-4xl font-bold text-highlight-text mb-4 tracking-tight">
                      Product Architecture & System Engineering{" "}
                    </h2>
                    <p className="text-primary-text text-lg max-w-2xl leading-relaxed">
                      Architected and deployed scalable SaaS platforms and
                      intelligent systems — designed with tenant isolation,
                      clean service layers, and production reliability at the
                      core.{" "}
                    </p>
                  </div>
                ...
                >
                  <div className="mb-12 text-center md:text-left">
                    ...
                    <p className="text-primary-text text-lg max-w-2xl leading-relaxed mx-auto md:mx-0">
                      From building full-stack applications to designing
                      multi-tenant SaaS platforms and intelligent backend
                      systems, driven by scalability and system design thinking.
                    </p>
                  </div>
                  <Experience />
                </motion.div>
                ...
                >
                  <div className="mb-12">
                    ...
                    <p className="text-primary-text text-lg max-w-2xl leading-relaxed">
                      A curated set of technologies used to build resilient,
                      scalable, and delightful applications.
                    </p>
                  </div>
                  <TechStack />
                </motion.div>
                ...
                >
                  <div className="mb-12">
                    ...
                    <p className="text-primary-text text-lg max-w-2xl leading-relaxed">
                      Discipline, teamwork, and continuous learning — shaped by
                      the field, the page, and the service.
                    </p>
                  </div>
                  <Hobbies />
                </motion.div>
                ...
                >
                  <div className="mb-12 text-center">
                    ...
                    <p className="text-primary-text text-lg max-w-2xl leading-relaxed mx-auto">
                      Available for architectural consultations, MVP
                      development, AI integrations, or joining high-growth teams.
                    </p>
                  </div>
                  <Services />
                </motion.div>
                ...
                <div className="w-full max-w-5xl">
                  <div className="mb-8 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="font-mono text-highlight-text/80 text-sm uppercase tracking-widest">
                        Mandela-OS Console
                      </h2>
                    </div>
